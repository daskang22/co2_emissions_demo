...
emissions_long_1990_2022 = emissions_long[emissions_long["Year"].between(1990, 2022)]
...
emissions_long_subset = emissions_long_1990_2022[
    emissions_long_1990_2022["country"].isin(
        ["USA", "China", "Germany", "India", "Brazil"]
    )
]
...
fig_chart = px.line(
    ...
    y="Emissions",
    color="country",
    title="Emissions Over Time (1990-2022)",
    labels={"Emissions": "CO2 Emissions", "Year": "Year"},
)
...
```{python}
# replace teh UAE value
emissions_long_1990_2022 = emissions_long_1990_2022.replace(
